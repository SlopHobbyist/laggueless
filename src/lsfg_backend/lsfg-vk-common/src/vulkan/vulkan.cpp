...
namespace {
    /// load vulkan-1.dll and return its handle
    HMODULE get_vulkan_handle() {
    ...
    PFN_vkGetInstanceProcAddr get_mpa() {
        ...
        mpa = reinterpret_cast<PFN_vkGetInstanceProcAddr>(
            GetProcAddress(get_vulkan_handle(), "vkGetInstanceProcAddr"));
        if (!mpa)
...
VulkanDeviceFuncs vk::initVulkanDeviceFuncs(const VulkanInstanceFuncs& f, VkDevice d,
    ...
    return {
        ...
        .GetMemoryWin32HandleKHR = dpa<PFN_vkGetMemoryWin32HandleKHR>(f, d, "vkGetMemoryWin32HandleKHR"),
        .ImportSemaphoreWin32HandleKHR = dpa<PFN_vkImportSemaphoreWin32HandleKHR>(f, d, "vkImportSemaphoreWin32HandleKHR"),
        .GetSemaphoreWin32HandleKHR = dpa<PFN_vkGetSemaphoreWin32HandleKHR>(f, d, "vkGetSemaphoreWin32HandleKHR"),
